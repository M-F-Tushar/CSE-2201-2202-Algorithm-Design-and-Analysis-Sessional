...
Covers greedy method, greedy-choice property, optimal substructure, candidate selection, feasibility testing, the greedy connection to MST algorithms, fractional knapsack, coin change, Huffman coding, Fibonacci sequence, and activity selection. The full Prim, Kruskal, and DSU treatment is in Chapter 11.
